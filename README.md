...
A list of practical projects that I chose to solve in C++. These projects are divided in multiple categories, and each category has its own folder.

The [Catch](https://github.com/philsquared/Catch) unit-tests framework is used to provide verification
for each, and to show how I would use such frameworks.
...
[**Fibonacci Sequence**](src/numbers/fibonacci.cpp) - Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Mortgage Calculator**](src/numbers/mortgage.cpp) - Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan. For added complexity, add an option for users to select the compounding interval (Monthly, Weekly, Daily, Continually).
